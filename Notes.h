...
clsBankClient ConvertLinetoRecord(string Line, string Seperator = "#//#")
{
...
string ConvertRecordToLine(clsBankClient Client, string Seperator = "#//#")
{
...
vector <clsBankClient> LoadCleintsDataFromFile(string FileName)
{
...
void PrintClientCard(clsBankClient Client)
{
...
bool FindClientByAccountNumber(string AccountNumber, vector <clsBankClient> vClients, clsBankClient& Client)
{
...
clsBankClient ChangeClientRecord(string AccountNumber)
{
    clsBankClient Client;
...
vector <clsBankClient> SaveCleintsDataToFile(string FileName, vector <clsBankClient> vClients)
{
...
bool DeleteClientByAccountNumber(string AccountNumber, vector <clsBankClient>& vClients)
{
...
bool UpdateClientByAccountNumber(string AccountNumber, vector <clsBankClient>& vClients)
{
...
bool DepositBalanceToClientByAccountNumber(string AccountNumber, double Amount, vector <clsBankClient>& vClients)
{
    char Answer = 'n';
